...
const TextInput = ({
  ...
  return (
    <div className={`flex flex-col space-y-[5px] w-full ${className}`}>
      ...
      <div
        className={`flex bg-netral-10 space-x-[5px] items-center justify-center border-2 text-bodySm rounded-[10px] px-[10px] py-[5px] md:text-bodyBase md:rounded-[15px] md:px-[15px] md:py-[10px] w-full ${mappingColorBorder()}`}
      >
        {iconLeft}
        <input
          type="text"
          ...
          className={`font-helvetica-regular placeholder:font-helvetica_regular outline-none placeholder:text-netral-50 disabled:bg-transparent w-full inline-block`}
